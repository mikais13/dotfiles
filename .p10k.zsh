# Generated by Powerlevel10k configuration wizard on 2026-09-06 at 01:40 NZST.
...
#
#   - Git:
#     - Detailed Git status with file and commit counts.
...
() {
  ...
  function my_git_formatter() {
    ...
    # Fall back to vcs_info when gitstatus data is unavailable.
    ...
    # A negative count means Git skipped the dirty-state check.
